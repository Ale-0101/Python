...
function adicionarTarefa() {
    ...
    fetch('http://localhost:5000/save_tarefa', {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json' // Define que o corpo é um JSON
        },
        body: JSON.stringify(novaTarefa) // Converte o objeto para JSON
    })
    
    .then(data => console.log('Tarefa salva:', data)) // Exibe a resposta no console
